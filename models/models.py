...
class LightweightUNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=3):
        ...
        # Encoder
        self.enc1 = ConvBlock(in_channels * 2, 64)   # original + downsampled input
    ...
    def forward(self, x):
        ...
        x_fused = torch.cat([x, F.interpolate(x_down, size=x.shape[2:], mode='bilinear', align_corners=False)], dim=1)
